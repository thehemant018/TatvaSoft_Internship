...
export class AdminsideServiceService {
  ...
  MissionApplicationApprove(missionApplicationId: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/Mission/MissionApplicationApprove/${missionApplicationId}`, {});
  }

  MissionApplicationDelete(missionApplicationId: number): Observable<any> {
    
    return this.http.delete(`${this.apiUrl}/Mission/MissionApplicationDelete/${missionApplicationId}`);
  }
  ...
  DeleteMissionSkill(id: number) {
    return this.http.post(`${this.apiUrl}/MissionSkill/DeleteMissionSkill/${id}`, {});
  }
