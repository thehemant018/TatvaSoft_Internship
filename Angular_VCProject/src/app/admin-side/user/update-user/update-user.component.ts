    ...
    this.service.GetUserById(id).subscribe(
      (data: any) => {
        if (data && Object.keys(data).length > 0) {
          ...
          console.error('User data not found or invalid format:', data);
          this.toastr.error('User data not found or invalid format');
          // You may redirect or handle the error differently as per your application's requirement
        }
      },
      error => {
